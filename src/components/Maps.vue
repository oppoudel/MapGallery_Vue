<template>
  <div>
    <section class="nav">
        <div class="container">
          <div class="nav-left">
            <router-link to="/"><img src="../assets/CITY-LOGO.png" alt="Baltimore Logo"></router-link>
            <router-link to="/"><span class="title is-1 is-hidden-mobile"> City of Baltimore:</span><span class="title is-1"><em><small> Maps Gallery</small></em></span></router-link>
          </div>
        </div>
    </section>
